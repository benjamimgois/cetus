...
- **THEN** o código está dividido em arquivos como `cetuslib/config.py`, `cetuslib/terminal.py`, `cetuslib/workers.py`, `cetuslib/network.py`, `cetuslib/transfer.py`, `cetuslib/ui/*.py`, `cetuslib/main.py` e `cetuslib/utils.py`
...
O sistema SHALL garantir que não existam imports circulares entre módulos do pacote `cetus/`.
