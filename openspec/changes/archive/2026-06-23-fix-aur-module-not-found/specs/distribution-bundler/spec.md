...
O sistema SHALL invocar o bundler nos scripts de build Debian e AppImage antes de empacotar, e SHALL instalar o pacote `cetuslib/` no PKGBUILD AUR.
...
#### Scenario: AUR package instala cetuslib
- **WHEN** o PKGBUILD em `packaging/arch/PKGBUILD` é executado
- **THEN** o diretório `cetuslib/` é copiado para `/usr/share/cetus/cetuslib`
